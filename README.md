...
1. 미리 작성된 테스트 코드를 통과시키기 위한 코드를 직접 구현하고 PR을 올립니다.

2. 다른 참여자의 PR이 올라오면 해당 PR을 리뷰합니다.

### 모여서

1. 코드를 구현하고 다른 사람의 코드를 리뷰하면서 얻은 지식을 서로 공유합니다.

2. 다음 스프린트에 학습할 내용을 같이 정합니다.

3. 테스트 코드 작성자들은 다음 스프린트에 진행할 내용에 대해서 테스트 코드를 작성합니다. 
