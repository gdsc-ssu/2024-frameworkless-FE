# 02. 렌더링 - 동적 데이터 렌더링 - 가상 DOM

2장 렌더링의 섹션 03 ~ 05 부분을 구현하는 가이드입니다. [[관련 이슈]](https://github.com/gdsc-ssu/2024-frameworkless-FE/issues/11)

- `03. 구성 요소 함수`
- `04. 동적 데이터 렌더링`
- `05. 가상 DOM`

구현에 앞서, `02-rendering-function`에 작성했던 `view/counter.js`, `view/filters.js`, `view/todos.js` (혹은 추가로 작성한 코드들)을 가져와서 진행해주세요.
